...
from gym.wrappers import Monitor # MURFETD
...
def _monitor(env, path):
    episode_freq = env.monitor_interval
    
    return Monitor(env, path, video_callable=lambda episode_id: episode_id%episode_freq == 0, resume=True)
